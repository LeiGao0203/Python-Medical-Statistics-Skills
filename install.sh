...
repo_ref="${PY_MED_STATS_REF:-main}"
archive_url="${PY_MED_STATS_ARCHIVE_URL:-https://github.com/LeiGao0203/Python-Medical-Statistics-Skills/archive/refs/heads/$repo_ref.tar.gz}"
tmp_dir=""
...
if [ -n "${PY_MED_STATS_SOURCE:-}" ]; then
  source_dir="$PY_MED_STATS_SOURCE"
...
for required in advanced-stats basic-stats literature-stats python-script jupyter-notebook; do
